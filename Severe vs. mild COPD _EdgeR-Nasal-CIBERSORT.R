...
names(tT2)[1] <- "ENSGid"
readr::write_csv(tT2, file = file.path (results.dir, "nasal-severe.vs.mildCOPD_FDR0.05_CIBER.txt"))

#tT3=tT1[which(tT1$FDR<0.01), ]
#names(tT3)[1] <- "ENSGid"
#readr::write_csv(tT3, file = file.path (results.dir, "nasal-severe.vs.mildCOPD_FDR0.01_CIBER.txt"))

#tT4=tT1[which(tT1$PValue<0.05),]
#names(tT4)[1] <- "ENSGid"
#readr::write_csv(tT4, file = file.path (results.dir, "nasal-severe.vs.mildCOPD_P0.05_CIBER.txt"))

#tT5=tT1[which(tT1$PValue<0.01),]
#names(tT5)[1] <- "ENSGid"
#readr::write_csv(tT5, file = file.path (results.dir, "nasal-severe.vs.mildCOPD_P0.01_CIBER.txt"))
...
dim (tT23)
readr::write_csv(tT23, file = file.path (results.dir, "nasal_all-DEGs_severe.vs.mildCOPD-CIBER-FDR0.05FC2.csv"))
...
write.csv(normalized_counts.FDR, file = file.path (results.dir, "nasal-normalized_counts-CIBER-FDR0.05.severe.vs.mildCOPD.csv"))
...
write.csv(normalized_counts.FDRa, file = file.path (results.dir, "nasal-normalized_counts.top20-CIBER-FDR0.05.severe.vs.mildCOPD.csv"))
...
ph <- pheatmap(datax,
              ...
              fontsize_row = 12, 
              fontsize_col = 10,
              filename = file.path (results.dir.img, "Heatmap_nasal_severe.vs.mildCOPD_FDR0.05_CIBER.png") ,dpi=600)
