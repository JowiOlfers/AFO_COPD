...
dim (tT23)
readr::write_csv(tT23, file = file.path (results.dir, "bronchial_allDEGs_severe.vs.controls-CIBER-FDR0.05FC2.csv"))
...
#mildvscontrol <- read.table("bronchial_allDEGs_mild.vs.controls-CIBER-FDR0.01FC.csv")
...
#dim (tT33)
#write.table(tT33, "bronchial_all-excluded-DEGs_severe.vs.controls-CIBER-FDR0.01FC.csv")
#
#tT31 =tT33 [which(tT33$logFC >= 1),] 
#dim (tT31)
#write.table(tT31, "bronchial_excluded-up-DEGs_severe.vs.controls-CIBER-FDR0.01FC.csv")
#
#tT32 =tT33[which(tT33$logFC <= -1), ]
#dim (tT32)
#write.table(tT32, "bronchial_excluded-down-DEGs_severe.vs.controls-CIBER-FDR0.01FC.csv")
...
readr::write_csv(normalized_counts.FDR, file = file.path (results.dir, "bronchial-normalized_counts-CIBER-FDR0.05.severevscontrol.csv"))
...
readr::write_csv(normalized_counts.FDR, file = file.path (results.dir, "bronchial-normalized_counts.top20-CIBER-FDR0.05.severevscontrol.csv"))
