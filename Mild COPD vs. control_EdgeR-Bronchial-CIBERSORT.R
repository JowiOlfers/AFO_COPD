...
names(tT2)[1] <- "ENSGid"
readr::write_csv(tT2, file = file.path (results.dir, "bronchial-mildCOPD.vs.control_CIBER_FDR0.05.txt"))
...
p
ggsave (filename = file.path (results.dir.img, "Volcano-bronchial-mildvscontrol-CIBER-FDR0.05.png"), width=25,height=25,units="cm",dpi=600 )
ggsave (filename = file.path (results.dir.img, "gene_diff-bronchial-mildvscontrol-CIBER-FDR0.05.pdf"), width=25,height=25,units="cm")
...
dim (tT21)
readr::write_csv(tT21, file = file.path (results.dir, "bronchial_up-DEGs_mild.vs.controls-CIBER-FDR0.05FC2.csv"))

tT22=tT2[which(tT2$logFC <= -1), ]
dim (tT22)
readr::write_csv(tT22, file = file.path (results.dir, "bronchial_down-DEGs_mild.vs.controls-CIBER-FDR0.05FC2.csv"))
...
readr::write_csv(tT23a, file = file.path (results.dir, "bronchial_top20.DEGs_mild.vs.controls-CIBER-FDR0.05FC2.csv"))
...
ph <- pheatmap(datax,
              ...
              fontsize_row = 10, 
              fontsize_col = 10,
              filename = file.path (results.dir.img, "Heatmap_bronchial_mild.vs.control_CIBER_FDR0.05.png") ,dpi=600)
