...
#FDR 0.5
#x <-readr::read_csv(
#  file.path(data.dir , "bronchial_all-DEGs_mild.vs.controls-FDR0.05FC2.csv"))
#df1 <- data.frame(x)
...
x <-readr::read_csv(
  file.path(data.dir, "bronchial_all-DEGs_severe.vs.controls-FDR0.05FC2.csv"))
table2 <- data.frame(x)
...
### Mild vs. severe COPD
#x <-readr::read_csv(
#  file.path(data.dir, "bronchial_all-DEGs_mildvssevere-FDR0.05FC2.csv"))
#table4 <- data.frame(x)
