...
names(tT2)[1] <- "ENSGid"
readr::write_csv(tT2, file = file.path (results.dir, "nasal-severe.vs.mildCOPD_NNLS_FDR0.05.txt"))

tT3=tT1[which(tT1$FDR<0.01), ]
names(tT3)[1] <- "ENSGid"
readr::write_csv(tT3, file = file.path (results.dir, "nasal-severe.vs.mildCOPD_NNLS_FDR0.01.txt"))

#tT4=tT1[which(tT1$PValue<0.05),]
#names(tT4)[1] <- "ENSGid"
#readr::write_csv(tT4, file = file.path (results.dir, "nasal-severe.vs.mildCOPD_NNLS_P0.05.txt"))

#tT5=tT1[which(tT1$PValue<0.01),]
#names(tT5)[1] <- "ENSGid"
#readr::write_csv(tT5, file = file.path (results.dir, "nasal-severe.vs.mildCOPD_NNLS_P0.01.txt"))

#tT6=tT1[which(tT1$PValue<0.001),]
#names(tT6)[1] <- "ENSGid"
#readr::write_csv(tT6, file = file.path (results.dir, "nasal-severe.vs.mildCOPD_NNLS_P0.001.txt"))
...
dim (tT23)
readr::write_csv(tT23, file = file.path (results.dir, "nasal_allDEGs_severe.vs.mildCOPD-NNLS-FDR0.05FC2.csv"))
...
#readr::write_csv(tT31, file = file.path (results.dir, "nasal_up-DEGs_severe.vs.mildCOPD-NNLS-FDR0.01FC2.csv"))

#tT32=tT3[which(tT3$logFC <= -1), ]
#readr::write_csv(tT31, file = file.path (results.dir, "nasal_down-DEGs_severe.vs.mildCOPD-NNLS-FDR0.01FC2.csv"))
...
#readr::write_csv(tT33a, file = file.path (results.dir, "nasal_top20.DEGs_severe.vs.mildCOPD-NNLS-FDR0.01FC2.csv"))
...
#readr::write_csv(tT323a, file = file.path (results.dir, "nasal_top20.DEGs_severe.vs.mildCOPD-NNLS-FDR0.01FC2.csv"))
...
readr::write_csv(normalized_counts.FDR, file = file.path (results.dir, "nasal-normalized_counts-NNLS-FDR0.05.severe.vs.mildCOPD.csv"))
...
readr::write_csv(normalized_counts.FDRa, file = file.path (results.dir, "nasal-normalized_counts.top20-NNLS-FDR0.05.severe.vs.mildCOPD.csv"))
...
ph <- pheatmap(datax,
              ...
              fontsize_row = 12, 
              fontsize_col = 10,
              filename = file.path (results.dir.img, "Heatmap_nasal_severe.vs.mildCOPD_NNLS_FDR0.05.png") ,dpi=600)
