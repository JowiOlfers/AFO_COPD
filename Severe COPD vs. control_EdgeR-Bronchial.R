...
dim (tT23)
readr::write_csv(tT23, file = file.path (results.dir, "bronchial_all-DEGs_severe.vs.controls-FDR0.05FC2.csv"))
...
write.csv(normalized_counts.FDR, file = file.path (results.dir, "bronchial-normalized_counts.FDR0.05.severevscontrol.csv"))
...
write.csv(normalized_counts.FDRa, file = file.path (results.dir, "bronchial-normalized_counts.top20-FDR0.05.severevscontrol.csv"))
