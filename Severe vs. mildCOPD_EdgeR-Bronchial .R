...
readr::write_csv(tT1, file = file.path (results.dir, "bronchial-severeCOPD.vs.mild.txt"))

tT2=tT1[which(tT1$FDR<0.05),]
names(tT2)[1] <- "ENSGid"
readr::write_csv(tT2, file = file.path (results.dir, "bronchial-severeCOPD.vs.mild_FDR0.05.txt"))

tT3=tT1[which(tT1$FDR<0.01),]
names(tT3)[1] <- "ENSGid"
readr::write_csv(tT3, file = file.path (results.dir, "bronchial-severeCOPD.vs.mild_FDR0.01.txt"))

tT4=tT1[which(tT1$PValue<0.01),]
names(tT4)[1] <- "ENSGid"
readr::write_csv(tT4, file = file.path (results.dir, "bronchial-severeCOPD.vs.mild_P0.01.txt"))

tT5=tT1[which(tT1$PValue<0.001),]
names(tT5)[1] <- "ENSGid"
readr::write_csv(tT5, file = file.path (results.dir, "bronchial-severeCOPD.vs.mild_P0.001.txt"))
...
p
ggsave (filename = file.path (results.dir.img, "Volcano-bronchial-severevsmild-FDR0.05.png"), width=25,height=25,units="cm",dpi=600 )
ggsave (filename = file.path (results.dir.img, "gene_diff-bronchial-severevsmild-FDR0.05.pdf"), width=25,height=25,units="cm")
...
#
#p1
#ggsave (filename = file.path (results.dir.img, "Volcano-bronchial-severevsmild-PValue.png"), width=30,height=25,units="cm",dpi=600 )
#ggsave (filename = file.path (results.dir.img, "gene_diff-bronchial-severevsmild-PValue.pdf"), width=25,height=25,units="cm")
...
dim (tT21)
readr::write_csv(tT21, file = file.path (results.dir, "bronchial_up-DEGs_severevsmild-FDR0.05FC2.csv"))

tT22=tT2[which(tT2$logFC <= -1), ]
dim (tT22)
readr::write_csv(tT22, file = file.path (results.dir, "bronchial_down-DEGs_severevsmild-FDR0.05FC2.csv"))

tT23 <- rbind (tT21, tT22)
dim (tT23)
readr::write_csv(tT23, file = file.path (results.dir, "bronchial_allDEGs_severevsmild-FDR0.05FC2.csv"))
...
readr::write_csv(tT23a, file = file.path (results.dir, "bronchial_top20.DEGs_severevsmild-FDR0.05FC2.csv"))
...
readr::write_csv(tT223a, file = file.path (results.dir, "bronchial_top10.DEGs_severevsmild-FDR0.05FC2.csv"))
...
#dim (tT33)
#write.table(tT33, "bronchial_all-excluded-DEGs_severevsmild-FDR0.01FC.csv")
#
#tT31 =tT33 [which(tT33$logFC >= 1),] 
#dim (tT31)
#write.table(tT31, "bronchial_excluded-up-DEGs_severevsmild-FDR0.01FC.csv")
#
#tT32 =tT33[which(tT33$logFC <= -1), ]
#dim (tT32)
#write.table(tT32, "bronchial_excluded-down-DEGs_severevsmild-FDR0.01FC.csv")
...
readr::write_csv(normalized_counts.FDR, file = file.path (results.dir, "bronchial-normalized_counts.FDR0.05.severevsmild.csv"))
...
readr::write_csv(normalized_counts.FDR, file = file.path (results.dir, "bronchial-normalized_counts.top20-FDR0.05.severevsmild.csv"))
...
ph <- pheatmap(datax,
               ...
               fontsize_row = 12, 
               fontsize_col = 10,
               filename = file.path (results.dir.img, "Heatmap_bronchial_severe.vs.mild_FDR0.05.png") ,dpi=600)
